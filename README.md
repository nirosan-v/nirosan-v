...
### Featured Projects
- [**London Job Market Analysis**](https://github.com/nirosan-v/) - SQL data cleaning and Tableau project analysing 10,000+ job listings to identify hiring trends, salary insights and role demand (repo documentation in progress)
- [**Amazon Price Tracker**](https://github.com/nirosan-v/amazon-price-tracker) - Python web scraping and automation project for tracking Amazon prices and sending alerts

---

### Current Focus  
- Strengthening **SQL + Excel expertise**  
- Building and polishing data visualisations in **Power BI + Tableau**  
- Developing my **portfolio website** to showcase projects, share insights and document my learning journey
